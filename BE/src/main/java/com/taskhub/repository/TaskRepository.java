...
public interface TaskRepository extends JpaRepository<Task, Long> {
    ...
    Page<Task> findAvailableTasks(@Param("status") TaskStatus status, @Param("excludeUserId") Long excludeUserId,
            Pageable pageable);
    ...
    Page<Task> findAvailableTasks(@Param("statuses") List<TaskStatus> statuses,
            @Param("excludeUserId") Long excludeUserId, Pageable pageable);
